...
const projects = [
  {
    ...
    github: "https://github.com/mohibnawaz",
    live: "https://example.com",
  },
  {
    id: 2,
    title: "AI Content Generator",
    description: "An AI-powered application that generates custom content based on user prompts and preferences.",
    image: "/placeholder.svg?height=600&width=800",
  ...
  },
  {
    ...
    description: "A secure messaging platform with end-to-end encryption and real-time notifications.",
    image: "/placeholder.svg?height=600&width=800",
